...
dropseq.integrated <- readRDS("/storage/CTR-Projects/CTR_DropSeq/NewMegatron/NewAlignments_50bp/HARMONY.orig_400g_500g/HARMONY_matrix.su_umap_n.neigh25_repuls2_spread2L_harmony_ORIG_500g.Rds")
...
table(dropseq.integrated@meta.data$SCT_snn_res.1)
...
reso <- 1.0
pdf(paste("DotPlot_", Project, "_", "umap.Cluster_no_legend_","res_", reso,"v2.pdf", sep = "_"), width=9, height=5)
par(bg=NA)
...
#saveRDS(list_umaps_for_plotting_noLegend,"list_umaps_for_plotting_noLegend_500g.Rds")
...
#saveRDS(list_umaps_for_plotting_2,"list_umaps_for_plotting2_cc_clust_expt_500g.Rds")
...
rownames(marker_tbl) <- c("c0","c1","c2","c3","c4","c5","c6","c7","c8","c9","c10","c11","c12","c13","c14","c15","c16","c17","c18","c19","c20","c21","c22") 
colnames(marker_tbl) <- c("c0","c1","c2","c3","c4","c5","c6","c7","c8","c9","c10","c11","c12","c13","c14","c15","c16","c17","c18","c19","c20","c21","c22") 

table(dropseq.integrated@meta.data[, paste0("SCT_snn_", reso)])



dataset_name <- "CTR_dscj1_HARMONY.orig_500g_markers"
...
#saveRDS(result_list, "result_list_harmony.orig_500g.Rds")
